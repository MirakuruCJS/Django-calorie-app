...
class Profile(models.Model):
	...
	meal = models.CharField(max_length=50, choices=meals, default='صبحانه')
	...
	def save(self, *args, **kwargs):
		if self.food_selected != None:
			...
			PostFood.objects.create(profile=calories,food=self.food_selected,calorie_amount=self.calorie_count,amount=self.quantity,option=self.meal)
...
class PostFood(models.Model):
    ...
    option = models.CharField(max_length=50, default='صبحانه')
